...
answer = input (
    "You are on a dirt road, it has come to an end and you can go left or right.Which may would you like to go? ").lower()
...
if answer == "left":
    ...
    if answer == "back":
        ...
        answer = input(
            "You cross a bridge and meet a stranger. Do you want to talk them (yes/no)? ")
